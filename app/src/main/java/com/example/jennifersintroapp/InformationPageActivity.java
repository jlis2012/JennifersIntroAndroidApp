...
public class InformationPageActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swcAllergy = (Switch) findViewById(R.id.swcAllergy);
    ...
    public void onClick(View v) {
        ...
        allergies = (String) (swcAllergy.isChecked() ? swcAllergy.getTextOn() : swcAllergy.getTextOff());
        ...
        //pass information to the results activity
